...
## Available Docker images
  ...
  * [ashedpotatoes/iqbal-clockwork-plus-ref-genomes-full]() -- same as ashedpotatoes/iqbal-clockwork-plus-ref-genomes-slim but also includes the 12 GB decontamination reference. This is its own Docker image as it is unusually large, and because only `clockwork remove_contam` and its WDL wrappers need that huge reference.
